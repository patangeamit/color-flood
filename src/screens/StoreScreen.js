      ...
      >
        <View style={styles.shopSection}>
          <View style={styles.dailyRewardCard}>
            <View>
              <Text style={styles.dailyRewardEyebrow}>Daily reward</Text>
              <Text style={styles.dailyRewardTitle}>+{dailyRewardAmount} Gems</Text>
              <Text style={styles.dailyRewardSubtitle}>
                {isDailyRewardReady
                  ? "Claim today’s free hard currency."
                  : `Next reward in ${dailyRewardCountdown}`}
              </Text>
            </View>
            <TouchableOpacity
              style={[
                styles.dailyRewardButton,
                !isDailyRewardReady && styles.dailyRewardButtonDisabled
              ]}
